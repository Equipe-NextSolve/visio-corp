...
export default function AboutHome() {
    return (
        <section className="relative w-full min-h-screen py-24 px-6 flex flex-col items-center justify-center overflow-hidden bg-gray">
            ...
            <div className="absolute top-0 left-0 w-72 h-72 bg-black/30 pointer-events-none" style={{ clipPath: "polygon(0 0, 100% 0, 0 100%)" }} />
            <div className="absolute bottom-0 right-0 w-80 h-80 bg-black/25 pointer-events-none" style={{ clipPath: "polygon(100% 0, 100% 100%, 0 100%)" }} />
            ...
            <div className="relative z-10 flex items-center gap-2 mb-6">
                ...
                <span className="text-xs font-semibold tracking-[0.25em] uppercase text-gold font-[Poppins]">Nossa Empresa</span>
                <div className="w-6 h-px bg-gold" />
            </div>
            ...
            <div className="relative z-10 max-w-6xl w-full flex flex-col-reverse md:grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <p className="text-xl leading-relaxed text-white">Apresentamos a VisioCorp, uma empresa dedicada a cuidar da saúde visual como forma de valorizar as pessoas dentro das organizações.</p>
                    <p className="text-xl leading-relaxed text-white">Somos uma ótica corporativa especializada em ações de saúde visual no ambiente de trabalho, levando praticidade, prevenção e bem-estar para empresas e colaboradores.</p>
                    <p className="text-xl leading-relaxed text-white">Já impactamos positivamente diversos setores, sempre com compromisso, responsabilidade e excelência no atendimento. Mais do que vender óculos, promovemos qualidade de vida no ambiente corporativo.</p>
